...
from func.in_matrix_form_for_n2 import in_matrix_form_for_n2
from func.in_matrix_form_for_h2 import in_matrix_form_for_h2
import constants
...
def scipy_interpolation_h2(
    ...
    return in_matrix_form_for_h2(   # Записал новые значения в виде строки для следующего преобразования
